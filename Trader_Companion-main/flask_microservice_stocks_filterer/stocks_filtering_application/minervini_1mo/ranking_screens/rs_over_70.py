...
high_rsi_stocks[['Symbol', 'RSI']].to_csv('./ranking_screens/results/rs_over_70.csv', index=False)

print(f"Saved {len(high_rsi_stocks)} stocks with 14-day RSI > 70 to './ranking_screens/results/rs_over_70.csv'")