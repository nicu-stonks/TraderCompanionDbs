...
def is_200ma_trending_up(group):
    ...
    m4_ago = last_four_months['200MA'].iloc[-88]      # 4 months ago
    m3_ago = last_four_months['200MA'].iloc[-66]     # 3 months ago
    m2_ago = last_four_months['200MA'].iloc[-44]     # 2 months ago
